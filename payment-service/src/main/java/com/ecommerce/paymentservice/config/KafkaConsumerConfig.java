...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, JsonNode> consumerFactory(Deserializer<JsonNode> jsonNodeDeserializer) {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaTopicConfig.PAYMENT_SERVICE_GROUP);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        log.info("Kafka consumer configured with bootstrap servers: {}, group: {}", bootstrapServers, KafkaTopicConfig.PAYMENT_SERVICE_GROUP);
