...
public class RedisConfig {
    ...
    public CacheManager cacheManager(
        ...
        cacheConfigurations.put(CacheNames.USER_INFO, defaultConfig.entryTtl(Duration.ofMinutes(30)));

        log.info("Redis cache manager configured for Notification Service with {} cache configurations",
